...
__help__ = """
 ᐉ /define <text>*:* Type the word or expression you want to search\nFor example /define kill
 ᐉ /spell*:* while replying to a message, will reply with a grammar corrected version
 ᐉ /synonyms <word>*:* Find the synonyms of a word
 ᐉ /antonyms <word>*:* Find the antonyms of a word
"""
