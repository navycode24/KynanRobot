...
# from KynanRobot.modules.sql import warns_sql as warnssql
import KynanRobot.modules.sql.blacklist_sql as blacklistsql

# from KynanRobot.modules.sql import cust_filters_sql as filtersql
# import KynanRobot.modules.sql.welcome_sql as welcsql
import KynanRobot.modules.sql.locks_sql as locksql
import KynanRobot.modules.sql.notes_sql as sql

# from KynanRobot.modules.rules import get_rules
import KynanRobot.modules.sql.rules_sql as rulessql
from KynanRobot import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from KynanRobot.__main__ import DATA_IMPORT
from KynanRobot.modules.connection import connected
from KynanRobot.modules.helper_funcs.alternate import typing_action
from KynanRobot.modules.helper_funcs.chat_status import user_admin
from KynanRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        ...
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `KynanRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("KynanRobot{}.backup".format(chat_id))  # Cleaning file
