...
ᐉ /math*:* Math `/math 2^2+2(2)`
ᐉ /factor*:* Factor `/factor x^2 + 2x`
ᐉ /derive*:* Derive `/derive x^2+2x`
ᐉ /integrate*:* Integrate `/integrate x^2+2x`
ᐉ /zeroes*:* Find 0's `/zeroes x^2+2x`
ᐉ /tangent*:* Find Tangent `/tangent 2lx^3`
ᐉ /area*:* Area Under Curve `/area 2:4lx^3`
ᐉ /cos*:* Cosine `/cos pi`
ᐉ /sin*:* Sine `/sin 0`
ᐉ /tan*:* Tangent `/tan 0`
ᐉ /arccos*:* Inverse Cosine `/arccos 1`
ᐉ /arcsin*:* Inverse Sine `/arcsin 0`
ᐉ /arctan*:* Inverse Tangent `/arctan 0`
ᐉ /abs*:* Absolute Value `/abs -1`
ᐉ /log*:* Logarithm `/log 2l8`
