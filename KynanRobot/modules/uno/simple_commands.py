...
from KynanRobot.unotils.user_setting import UserSetting
from KynanRobot.unotils.utils import send_async
from KynanRobot import dispatcher
from KynanRobot.unotils.internationalization import _, user_locale
...
def stats(update: Update, context: CallbackContext):
    ...
    if not us or not us.stats:
        send_async(context.bot, update.message.chat_id,
                   text=_("You did not enable statistics. Use /usettings in "
...
HELP_HANDLER = CommandHandler("uhelp", help_handler)
STATS_HANDLER = CommandHandler("stats", stats)
MODES_HANDLER = CommandHandler("modes", modes)

dispatcher.add_handler(HELP_HANDLER)
dispatcher.add_handler(STATS_HANDLER)
dispatcher.add_handler(MODES_HANDLER)
