...
from KynanRobot.unotils import card as c
from KynanRobot.unotils import settings
from KynanRobot.unotils.actions import do_skip, do_play_card, do_draw, do_call_bluff, start_player_countdown
from config import WAITING_TIME, DEFAULT_GAMEMODE, MIN_PLAYERS
from KynanRobot.unotils.errors import (NoGameInChatError, LobbyClosedError, AlreadyJoinedError,
                    NotEnoughPlayersError, DeckEmptyError)
from KynanRobot.unotils.internationalization import _, __, user_locale, game_locales
from KynanRobot.unotils.results import (add_call_bluff, add_choose_color, add_draw, add_gameinfo,
                     add_no_game, add_not_started, add_other_cards, add_pass,
                     add_card, add_mode_classic, add_mode_fast, add_mode_wild, add_mode_text)
from KynanRobot import gm, updater, dispatcher
from .simple_commands import help_handler
from KynanRobot.unotils.utils import display_name
from KynanRobot.unotils.utils import send_async, answer_async, error, TIMEOUT, user_is_creator_or_admin, user_is_creator, game_is_running
...
dispatcher.add_handler(CommandHandler('ukill', kill_game))
